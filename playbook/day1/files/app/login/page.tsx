...
// Day 1 change: the demo-credentials panel is now gated behind NEXT_PUBLIC_DEMO_MODE.
// In any customer build, set NEXT_PUBLIC_DEMO_MODE=false (or just don't set it).
        ...
        <div className="card shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="email" className="input-field" placeholder="you@agency.com"
            ...
            <button type="submit" disabled={submitting} className="btn-gold w-full justify-center mt-2">
